        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-8">
                ...
                <div class="card card-chart">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('presence_teacher.update', $edit_presence_teachers ->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="table_classroom_id" class="form-control select @error('table_classroom_id') is-invalid @else is-valid @enderror">
                                                ...
                                                @php $opti_classroom = ($users_ac->id == $edit_presence_teachers->table_classroom_id) ? 'selected' : ''; @endphp
                                                <option class="optins" value="{{ $users_ac->id }}" {{ $opti_classroom }}>{{ $users_ac->offline_class }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="table_classroom_id" class="form-control select @error('table_classroom_id') is-invalid @else is-valid @enderror">
                                                <option>--- Select Classroom ID ---</option>
                                                @foreach($classroom as $users_ac)
                                                @php $sel = ($users_ac->id == $edit_presence_teachers->table_classroom_id) ? 'selected' : ''; @endphp
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="table_teachers_id" class="form-control select @error('table_teachers_id') is-invalid @else is-valid @enderror">
                                                ...
                                                @php $sel = ($users_ac->id == $edit_presence_teachers->table_teachers_id) ? 'selected' : ''; @endphp
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="date" name="date_presence" value="{{ $edit_presence_teachers->date_presence }}" class="form-control @error('date_presence') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="time" name="clock_presence" value="{{ $edit_presence_teachers->clock_presence }}" class="form-control @error('clock_presence') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="status_presence" class="form-control @error ('status_presence') is-invalid @else is-valid @enderror" id="status_teac">
                                                ...
                                                <option class="optins" value="Present" {{ $edit_presence_teachers->status_presence == "Present" ? 'selected': '' }}>Present</option>
                                                <option class="optins" value="Not Present" {{ $edit_presence_teachers->status_presence == "Not Present" ? 'selected': '' }}>Not Present</option>
                                                <option class="optins" value="Presence Permissions" {{ $edit_presence_teachers->status_presence == "Presence Permissions" ? 'selected': '' }}>Presence Permissions</option>
                                            </select>
