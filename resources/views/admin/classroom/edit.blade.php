            ...
            <div class="col-md-12 col-lg-4">
                ...
                <div class="card card-chart">
                    ...
                    <div id="" class="">
                        ...
                        <a class="list-group-item list-group-item-action active">Classroom Edit</a>
                    </div>
                </div>
            ...
            <div class="col-md-12 col-lg-8">
                ...
                <div class="card card-chart">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="card-title judul-detail">Edit Classroom</h5>
                            </div>
                            <div class="col-6">
                                <ul class="chart-list-out">
                                    <li><span class="circle-blue"></span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('classroom.edit', $classroom_edit->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" name="offline_class" value="{{ $classroom_edit->offline_class }}" class="form-control @error('offline_class') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" name="online_class" value="{{ $classroom_edit->online_class }}" class="form-control @error('online_class') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="table_students_id" class="form-control select @error('table_students_id') is-invalid @else is-valid @enderror">
                                                ...
                                                @php $opti_students = ($users_ac->id == $classroom_edit->table_students_id) ? 'selected' : ''; @endphp
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="table_teachers_id" class="form-control select @error('table_teachers_id') is-invalid @else is-valid @enderror">
                                                ...
                                                @php $opti_teachers = ($users_ac->id == $classroom_edit->table_teachers_id) ? 'selected' : ''; @endphp
                                                <option class="optins" value="{{ $users_ac->id }}" {{ $opti_teachers }}>{{ $users_ac->name_teachers }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="table_course_id" class="form-control select @error('table_course_id') is-invalid @else is-valid @enderror">
                                                ...
                                                @php $opti_course = ($users_ac->id == $classroom_edit->table_course_id) ? 'selected' : ''; @endphp
                                                <option class="optins" value="{{ $users_ac->id }}" {{ $opti_course }}>{{ $users_ac->course_univesity }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="time" name="clock_start" value="{{ $classroom_edit->clock_start }}" class="form-control @error('clock_start') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="time" name="clock_end" value="{{ $classroom_edit->clock_end }}" class="form-control @error('clock_end') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="date" name="date_start" value="{{ $classroom_edit->date_start }}" class="form-control @error('date_start') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="date" name="date_end" value="{{ $classroom_edit->date_end }}" class="form-control @error('date_end') is-invalid @else is-valid @enderror">
