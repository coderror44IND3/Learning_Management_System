            ...
            <div class="col-md-12 col-lg-4">
                ...
                <div class="card card-chart">
                    ...
                    <div id="" class="">
                        ...
                        <a class="list-group-item list-group-item-action active">Lesson Students Edit</a>
                    </div>
                </div>
            ...
            <div class="col-md-12 col-lg-8">
                ...
                <div class="card card-chart">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="card-title judul-detail">Edit Lesson Students</h5>
                            </div>
                            <div class="col-6">
                                <ul class="chart-list-out">
                                    <li><span class="circle-blue"></span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('grade_class.edit', $edit_lesson->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" name="name_score" value="{{ $edit_lesson->name_score }}" class="form-control @error('name_score') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" name="dailytasks_score" value="{{ $edit_lesson->dailytasks_score }}" class="form-control @error('dailytasks_score') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" name="presence_score" value="{{ $edit_lesson->presence_score }}" class="form-control @error('presence_score') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" name="uts_score" value="{{ $edit_lesson->uts_score }}" class="form-control @error('uts_score') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" name="uas_score" value="{{ $edit_lesson->uas_score }}" class="form-control @error('uas_score') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="table_course_id" class="form-control select @error('table_course_id') is-invalid @else is-valid @enderror">
                                                ...
                                                @php $opti_course = ($users_ac->id == $edit_lesson->table_course_id) ? 'selected' : ''; @endphp
