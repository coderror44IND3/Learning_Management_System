            ...
            <div class="col-md-12 col-lg-4">
                ...
                <div class="card card-chart">
                    ...
                    <div id="" class="">
                        ...
                        <a class="list-group-item list-group-item-action active">Money Class Add</a>
                    </div>
                </div>
            ...
            <div class="col-md-12 col-lg-8">
                ...
                <div class="card card-chart">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="card-title judul-detail">Create Money Class</h5>
                            </div>
                            <div class="col-6">
                                <ul class="chart-list-out">
                                    <li><span class="circle-blue"></span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('money.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>Name Students <span class="login-danger">*</span></label>
                                            <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" name="class_students" value="{{ old('class_students') }}" class="form-control @error('class_students') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="date" name="date" value="{{ old('date') }}" class="form-control @error('date') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="time" name="clock" value="{{ old('clock') }}" class="form-control @error('clock') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="number" name="money_students" value="{{ old('money_students') }}" class="form-control @error('money_students') is-invalid @else is-valid @enderror">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="status_students" class="form-control @error ('status_students') is-invalid @else is-valid @enderror" id="status_students">
                                                ...
                                                <option class="optins" value="Unpaid">Unpaid</option>
                                                <option class="optins" value="Paid">Paid</option>
                                            </select>
