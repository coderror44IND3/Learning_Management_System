        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-7">
                ...
                <div class="student-group-form">
                    <form action="/searchstudentspresence" method="GET">
                        <div class="row">
                ...
                <div class="card card-chart">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="card-title judul-detail">Presence Students</h5>
                            </div>
                            <div class="col-6">
                                <ul class="chart-list-out">
                                    <li><span class="circle-blue"></span>
                        ...
                        <div class="col-auto text-end float-end ms-auto download-grp mt-3">
                            ...
                            @endif
                            @if(Auth::user()->role == 'Admin' || Auth::user()->role == 'Teachers')
                            <button onclick="createpresences();" class="btn btn-primary"><i class="fa fa-plus-circle" title="Create" style="font-size: 18px;"></i></button>
                            @endif
                        </div>
                    </div>
                    <hr>
